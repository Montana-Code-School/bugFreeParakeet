  ...
  changeBackground(e){
    ...
    if(e.target.id == 0){
      body.style.setProperty('--background',
        'url('+catBackground+') no-repeat center center fixed');
    }else if(e.target.id == 1){
      body.style.setProperty('--background',
        'url('+catBackground3+') no-repeat center center fixed');
    }else if(e.target.id==2){
      body.style.setProperty('--background',
        'url('+catBackground4+') no-repeat center center fixed');
    }
  }
  render(){
    return(
      <div>
        ...
        <Link to="/home">
          <button
            ...
            onMouseEnter={(e) => this.storyChooser(e)}
            onClick={(e)=>this.changeBackground(e)}
            id="1">
